<?php 
 ...
 <?php
    ...
    $query = "SELECT COUNT(id) as total FROM tbl_contacts WHERE is_important=true AND deleted_at=null";
    ...
    $mail_query = "SELECT * FROM tbl_contacts WHERE is_important=true AND deleted_at=null LIMIT $from, $per_page";
