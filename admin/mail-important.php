<?php 
 ...
 <?php
    ...
    $query = "SELECT COUNT(id) as total FROM tbl_contacts WHERE is_important=true";
    ...
    $mail_query = "SELECT * FROM tbl_contacts WHERE is_important=true LIMIT $from, $per_page";
